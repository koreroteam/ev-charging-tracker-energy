...
@Component({
  selector: 'ngx-charging-infra-heat-map',
  templateUrl: './charging-infra-heat-map.component.html',
  styleUrls: ['./charging-infra-heat-map.component.scss']
})
export class ChargingInfraHeatMapComponent implements OnInit, AfterViewInit {
