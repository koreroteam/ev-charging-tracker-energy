...
@Component({
  selector: 'ngx-strom-erzeuger-strom-speicher-netto-production',
  templateUrl: './strom-erzeuger-strom-speicher-netto-production.component.html',
  styleUrls: ['./strom-erzeuger-strom-speicher-netto-production.component.scss']
})
export class StromErzeugerStromSpeicheNettoProductionComponent implements OnInit, AfterViewInit {
  ...
  private createMap(): void {
    ...
    document.getElementById('heatMapContainerStromSpeicherNettoProduc').style.backgroundColor = "rgba(85,90,96,0.3)";
  
    this.map = L.map('heatMapContainerStromSpeicherNettoProduc', {
