...
@Component({
  selector: 'ngx-strom-erzeuger-wind-netto-production',
  templateUrl: './strom-erzeuger-wind-netto-production.component.html',
  styleUrls: ['./strom-erzeuger-wind-netto-production.component.scss']
})
export class StromErzeugerWindNettoProductionComponent implements OnInit, AfterViewInit {
  ...
  private createMap(): void {
    ...
    document.getElementById('heatMapContainerWindNettoProduc').style.backgroundColor = "rgba(85,90,96,0.3)";
  
    this.map = L.map('heatMapContainerWindNettoProduc', {
